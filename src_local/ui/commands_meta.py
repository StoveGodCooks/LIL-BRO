...
COMMANDS: list[tuple[str, str, str]] = [
    ...
    ("/reset",                  "active",      "Fresh session -- clears thread and removes saved project session"),
    ("/resume <session_id>",    "active",      "Resume a specific Claude session by ID on next restart"),
